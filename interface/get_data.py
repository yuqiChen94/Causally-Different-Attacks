...
def get_all_output(P1,P2,P3,P4,P5,P6):
...
def get_all_actuators(HMI):
    input_vector = [HMI.MV101.Status, HMI.P101.Status, HMI.P102.Status, HMI.MV201.Status,
                    HMI.P201.Status, HMI.P202.Status, HMI.P203.Status,
                    HMI.P204.Status, HMI.P205.Status, HMI.P206.Status, HMI.MV301.Status,
                    HMI.MV302.Status, HMI.MV303.Status, HMI.MV304.Status, HMI.P301.Status, HMI.P302.Status,
                    HMI.P401.Status, HMI.P402.Status, HMI.P403.Status,
                    HMI.P404.Status, HMI.UV401.Status, HMI.P501.Status, HMI.P502.Status, HMI.P601.Status,
                    HMI.P602.Status, HMI.P603.Status]
