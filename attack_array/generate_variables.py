...
def generate_plc_input(HMI):
    ...
    HMI.P5.State = random.randint(1, 21)
    HMI.P6.State = random.randint(1, 2)
    ...
    HMI.AIT501.Pv = random.uniform(2,14)
    HMI.AIT501.set_alarm()
    HMI.AIT502.Pv = random.uniform(0,800)
    HMI.AIT502.set_alarm()
    HMI.AIT503.Pv = random.uniform(0,1000)
    HMI.AIT503.set_alarm()
    HMI.AIT504.Pv = random.uniform(0,20)
    HMI.AIT504.set_alarm()
    # HMI.PIT501.Pv = 0
    # HMI.PIT502.Pv = 0
    # HMI.PIT503.Pv = 0
    HMI.FIT501.Pv = random.uniform(0,4)
    HMI.FIT501.set_alarm()
    HMI.FIT502.Pv = random.uniform(0,4)
    HMI.FIT502.set_alarm()
    HMI.FIT503.Pv = random.uniform(0,4)
    HMI.FIT503.set_alarm()
    HMI.FIT504.Pv = random.uniform(0,2)
    HMI.FIT504.set_alarm()
...
def get_all_input_without_sensors(HMI):
