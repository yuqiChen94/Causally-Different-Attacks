...
class plant:
    def __init__(self, init, time_interval, maxstep):
    ...
    def Plant(self, P1, P2, P3, P4, P5, P6,k,HMI):
        ...
        # LIT101_increase = self.p['f_mv101'] / self.p['S_t101']
        # print("LIT101_increase: %s" % LIT101_increase)
        #
        #
        # LIT101_decrease = self.p['f_p101'] / self.p['S_t101']
        # print("LIT101_decrease: %s" % LIT101_decrease)
        #
        #
        # LIT301_increase = self.p['f_mv201'] / self.p['S_t301']
        # print("LIT301_increase: %s" % LIT301_increase)
        #
        #
        # LIT301_decrease = self.p['f_p301'] / self.p['S_t301']
        # print("LIT301_decrease: %s" % LIT301_decrease)
        #
        #
        # LIT401_increase = self.p['f_mv302'] / self.p['S_t401']
        # print("LIT401_increase: %s" % LIT401_increase)
        #
        #
        # LIT401_decrease = self.p['f_p401'] / self.p['S_t401']
        # print("LIT401_decrease: %s" % LIT401_decrease)